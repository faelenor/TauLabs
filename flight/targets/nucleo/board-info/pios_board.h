 ...
 * @brief      Board specific defines for Nucleo
...
// GPIO
//-------------------------
// [0]: Output-> Nucleo Buzzer Pin, with active driver connected to GND
// [1]: Output-> Nucleo Battery Pin, take care of the voltage divider connected to this pin
// [2]-[9]: Input-> Nucleo PWN IN Pins 1-8, take care of the RcvrPort configuration in GCS and that the Pins are configured with a PullUp Resistor
